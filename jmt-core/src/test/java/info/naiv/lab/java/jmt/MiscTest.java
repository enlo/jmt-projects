...
public class MiscTest {
    ...
    public void testArrayCompareTo_4args() {
        ...
        Integer[] arr3 = {2, 2, 3};
        Integer[] arr4 = {1, 2, 3};
        assertThat(Misc.arrayCompareTo(arr1, 0, arr2, 0), is(greaterThan(0)));
        assertThat(Misc.arrayCompareTo(arr1, 1, arr3, 1), is(greaterThan(0)));
        assertThat(Misc.arrayCompareTo(arr3, 1, arr4, 0), is(greaterThan(0)));
        assertThat(Misc.arrayCompareTo(arr3, 0, arr4, 2), is(lessThan(0)));
        assertThat(Misc.arrayCompareTo(arr2, 1, arr3, 1), is(0));
    }
    ...
    public void testArrayCompareTo_6args() {
        ...
        Integer[] arr3 = {2, 2, 3};
        Integer[] arr4 = {1, 2, 3};
        assertThat(Misc.arrayCompareTo(arr1, 0, 3, arr2, 0, 3), is(0));
        assertThat(Misc.arrayCompareTo(arr3, 0, 2, arr4, 0, 1), is(greaterThan(0)));
    }
    ...
    public void testArrayCompareTo_GenericType_GenericType() {
        ...
        Integer[] arr3 = {2, 2, 3};
        Integer[] arr4 = {1, 2, 3};
        assertThat(Misc.arrayCompareTo(arr1, arr2), is(greaterThan(0)));
        assertThat(Misc.arrayCompareTo(arr1, arr3), is(lessThan(0)));
        assertThat(Misc.arrayCompareTo(arr3, arr4), is(greaterThan(0)));
        assertThat(Misc.arrayCompareTo(arr2, arr4), is(0));
    }
    ...
    public void testArrayEqualsInRange_5args_1() {
        ...
        byte[] arr2 = {3, 4, 5, 7};
        assertThat("1", Misc.arrayEqualsInRange(arr1, 0, arr2, 0, 3), is(false));
        assertThat("2", Misc.arrayEqualsInRange(arr1, 1, arr2, 0, 3), is(false));
        assertThat("3", Misc.arrayEqualsInRange(arr1, 2, arr2, 0, 1), is(true));
        assertThat("4", Misc.arrayEqualsInRange(arr1, 2, arr2, 0, 2), is(true));
        assertThat("5", Misc.arrayEqualsInRange(arr1, 2, arr2, 0, 3), is(true));
        assertThat("6", Misc.arrayEqualsInRange(arr1, 2, arr2, 0, 4), is(false));
        assertThat("7", Misc.arrayEqualsInRange(arr1, 2, arr2, 1, 2), is(false));
        assertThat("8", Misc.arrayEqualsInRange(arr1, 2, arr2, 2, 1), is(false));
        assertThat("9", Misc.arrayEqualsInRange(arr1, 3, arr2, 0, 3), is(false));
        assertThat("10", Misc.arrayEqualsInRange(arr1, 3, arr2, 1, 2), is(true));
        assertThat("11", Misc.arrayEqualsInRange(arr1, 3, arr2, 2, 1), is(false));
        assertThat("12", Misc.arrayEqualsInRange(arr1, 4, arr2, 0, 3), is(false));
        assertThat("13", Misc.arrayEqualsInRange(arr1, 4, arr2, 1, 2), is(false));
        assertThat("14", Misc.arrayEqualsInRange(arr1, 4, arr2, 2, 1), is(true));
    }
    ...
    /**
     * Test of arrayJoin method, of class Misc.
     */
    @Test
    public void testArrayJoin() {
        assertThat(Misc.arrayJoin(new String[]{"a", "b", "c"}), is("abc"));
        assertThat(Misc.arrayJoin(new Object[]{"a", null, 1}), is("a1"));
    }
    ...
    public void testSort() {
        List<Integer> x = Arrays.asList(Misc.sort(6, 3, 5, 2, 4, 1));
